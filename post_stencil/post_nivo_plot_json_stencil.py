...
parser.add_argument('--input_plottype', dest='input_plottype', help='Input plottype')
...
payload['statistics'] = [{}]
payload['libraryData'] = [post_util_stencil.get_datasets(args.config_file, args.input_id, args.input_datatype, args.input_plottype, args.tool_id, args.workflow_step_id, args.layoutId, args.tabId, args.stepId)]  ## key changed from "datasets" to "libraryData" 
